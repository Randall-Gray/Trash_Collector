...
{
    public class EmployeePickupsController : Controller
    {
        private readonly ApplicationDbContext _context;

        public EmployeePickupsController(ApplicationDbContext context)
        {
            _context = context;
        }
